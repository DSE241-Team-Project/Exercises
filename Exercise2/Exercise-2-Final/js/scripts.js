...
function chart(column, filterBy, groupBy) {
    ...
    var x = d3.scale.linear()
        //.domain([1924,2006])
        .domain([1924, 2006])
        //.domain([1924, 1928, 1932, 1936, 1948, 1952, 1956, 1960, 1964, 1968, 1972, 1976, 1980,1984, 1988, 1992, 1994, 1998, 2002, 2006])
        .range([0, width]);
        //.nice();
    ...
    var spacing = [0, (4/82)*width, (8/82)*width, (12/82)*width, (24/82)*width, (28/82)*width, (32/82)*width, (36/82)*width,
                    (40/82)*width, (44/82)*width, (48/82)*width, (52/82)*width, (56/82)*width, (60/82)*width, (64/82)*width,
                    (68/82)*width, (70/82)*width, (74/82)*width, (78/82)*width, width]
    var numberarr2 = years.map( function(value) { 
        return value - 1924; 
    } );
    var xAxis = d3.svg.axis()
        //.scale(x)
        //.tickValues(d3.range(0, 1000, 100))
        .tickValues(spacing)
        .orient('bottom')
        //.ticks(d3.time.years, 4);
        //.ticks(20)
        //.tickValues([0, 100, 600])
        .tickFormat(function (d,i) {
            return years[i];
        });
        //.tickValues([1924, 1928, 1932, 1936, 1948, 1952, 1956, 1960, 1964, 1968, 1972, 1976, 1980,1984, 1988, 1992, 1994, 1998, 2002, 2006])
        //.tickPadding(15);
        //.ticks(20)
        //.ticks(d3.time.years, 4)//should display 1 year intervals
